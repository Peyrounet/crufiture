...
CREATE TABLE cruf_lot (
    ...
    datetime_debut      DATETIME        DEFAULT NULL,     -- date et heure de mise en place sur la plaque (saisi au démarrage PWA)
                                                          -- permet le suivi multi-jours (production sur plusieurs jours)
...
--   cruf_lot :
--     - heure_debut TIME supprimé
--     + datetime_debut DATETIME — date + heure de mise en place (suivi multi-jours)
--       Reconstitué backend : date du jour + heure saisie sur la PWA
--
-- ============================================================
